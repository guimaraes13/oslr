...
public class ExampleParserTokenManager implements ExampleParserConstants {
    ...
    public static final String[] jjstrLiteralImages = {
            ...
            "\164\162\165\145", "\146\141\154\163\145", "\50", "\51", "\54", "\53", "\55", "\56", "\137", null,
            null, null,};
    /**
     * Lexer state names.
     */
        ...
        for (; ; ) {
            ...
            if (curChar < 64) {
                ...
                do {
                    switch (jjstateSet[--i]) {
                        case 0:
                            if (curChar == 39) { jjCheckNAddStates(0, 2); } else if (curChar == 34) {
                ...
                do {
                    switch (jjstateSet[--i]) {
                        ...
                        case 7:
                            ...
                            break;
                        case 8:
                        case 9: { jjCheckNAddStates(3, 5); }
                        break;
                        case 12:
                            if (curChar == 92) { jjstateSet[jjnewStateCnt++] = 13; }
                            break;
                        case 13:
                        case 14: { jjCheckNAddStates(0, 2); }
                        break;
                        default:
                            break;
                    }
