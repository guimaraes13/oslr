...
int jjmatchedKind;
    ...
    private void ReInitRounds() {
        int i;
        jjround = 0x80000001;
        for (i = 11; i-- > 0; ) { jjrounds[i] = 0x80000000; }
    }
        ...
        for (; ; ) {
            ...
            if (curChar < 64) {
                ...
                do {
                    switch (jjstateSet[--i]) {
                        case 0:
                            if (curChar == 34) { jjCheckNAddTwoStates(7, 9); } else if (curChar == 37) {
                                if (kind > 5) { kind = 5; }
                                { jjCheckNAdd(1); }
                            }
                            break;
            ...
            ++curPos;
            if ((i = jjnewStateCnt) == (startsAt = 11 - (jjnewStateCnt = startsAt))) { return curPos; }
