...
public class ExampleParser implements ExampleParserConstants {
    ...
    final public void readProPprExample(List proPprExamples) throws ParseException {
        ...
        while (true) {
            ...
            example = readAtom();
            examples.add(new Example(example, positive));
            switch ((jj_ntk == -1) ? jj_ntk_f() : jj_ntk) {
                case POSTIVE_SIGN:
                case NEGATIVE_SIGN: {
                    break;
    ...
    final public void readTerm(List<Term> terms) throws ParseException {
        Term term;
        switch ((jj_ntk == -1) ? jj_ntk_f() : jj_ntk) {
            case CONSTANT:
            case QUOTED: {
    ...
    final public Term readVariable() throws ParseException {
        Token variable;
